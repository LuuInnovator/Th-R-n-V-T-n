...
import { Zap, Shield, Beaker, Sparkles, Target, Star, BookOpen } from 'lucide-react';
      ...
      <div className="px-8 py-6 bg-slate-900/90 border-b border-slate-800 shrink-0 z-10 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-5">
                <div className="w-14 h-14 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center border border-white/10 shadow-lg shadow-indigo-900/20">
                ...
                <div>
                    ...
                    <div className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mt-2 flex items-center gap-2">
                       Hệ phái hiện tại: <span className="text-cyan-400 bg-cyan-400/5 px-3 py-1 rounded-full border border-cyan-400/20 font-black">{player.characterClass}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-slate-950 px-8 py-4 rounded-3xl border border-slate-800 flex flex-col items-center justify-center min-w-[200px] shadow-inner">
                ...
                <div className="text-3xl font-black text-indigo-400 tabular-nums drop-shadow-[0_0_15px_rgba(129,140,248,0.3)]">
      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-8 scrollbar-thin">
        <div className="max-w-7xl mx-auto space-y-12 pb-24">
            {branches.map(branch => {
                ...
                return (
                    <div key={branch.id} className="space-y-6">
                        <div className="flex items-center gap-4 border-l-4 border-indigo-500 pl-4 bg-indigo-500/5 py-2 pr-4 rounded-r-xl">
            ...
            <div className="bg-slate-900/20 border border-dashed border-slate-800 p-12 rounded-3xl text-center">
                ...
                <p className="text-xs text-slate-600 font-black uppercase tracking-[0.3em]">Khám phá các bí kỹ tối thượng để chinh phục Chúa Tể Hư Không</p>
            </div>
        </div>
      </div>
    </div>
